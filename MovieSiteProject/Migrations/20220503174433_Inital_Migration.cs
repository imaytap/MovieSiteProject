    ...
    public partial class Inital_Migration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranslateKeys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TranslateKeyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Translates_TranslateKeys_TranslateKeyId",
                        column: x => x.TranslateKeyId,
                        principalTable: "TranslateKeys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    XUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Users_XUserId",
                        column: x => x.XUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Comments_Users_XUserId",
                        column: x => x.XUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Actors_XUserId",
                table: "Actors",
                column: "XUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_XUserId",
                table: "Categories",
                column: "XUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translates_TranslateKeyId",
                table: "Translates",
                column: "TranslateKeyId");
