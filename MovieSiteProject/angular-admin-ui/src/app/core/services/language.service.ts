...
export class LanguageService
{
  ...
  add(addModel: LanguageModel): Observable<SingleResponseModel<LanguageModel>> {
    let newPath = apiUrl + 'languages/add';
    return this.httpClient.post<SingleResponseModel<LanguageModel>>(newPath, addModel);
  }
  ...
  update(updateModel: LanguageModel): Observable<SingleResponseModel<LanguageModel>> {
    let newPath = apiUrl + 'languages/update';
    return this.httpClient.post<SingleResponseModel<LanguageModel>>(newPath, updateModel);
  }

  getById(id: string): Observable<SingleResponseModel<LanguageModel>> {
