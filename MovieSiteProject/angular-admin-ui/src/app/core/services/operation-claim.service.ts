...
export class OperationClaimService {
  ...
  add(
    ...
    return this.httpClient.post<SingleResponseModel<OperationClaimModel>>(
      newPath,
  ...
  update(
    operationClaimModel: OperationClaimModel
  ): Observable<SingleResponseModel<OperationClaimModel>> {
  ...
  getById(id: string): Observable<SingleResponseModel<OperationClaimModel>> {
