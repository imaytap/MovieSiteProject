...
namespace MovieSiteProject.Core.Utilities.Helpers.InterceptorHelpers
{
    public static class AutofacInterceptorHelper
    {
        public static void ChangeReturnValue(IInvocation invocation, Type returnType, dynamic error, string message)
        {
            ...
            {
                var typeGeneric = returnType.MakeGenericType(invocation.Method.ReturnType.GenericTypeArguments[0]);
